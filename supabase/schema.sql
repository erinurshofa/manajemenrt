...
-- ==============================================================================
-- KEBIJAKAN KEAMANAN KETAT (ROW LEVEL SECURITY - RLS)
-- Mencegah modifikasi / penghapusan data oleh pihak anonim yang tidak login
-- ==============================================================================
...
ALTER TABLE public.user_credentials ENABLE ROW LEVEL SECURITY;
    ...
    -- 7. Kredensial (Dikunci Total dari Publik)
